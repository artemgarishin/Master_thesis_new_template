...
\textbf{CFGF} \hspace{21 mm} \textbf{C}ontrol \textbf{F}low \textbf{G}raph  \textbf{F}actory \\
\textbf{TC} \hspace{20 mm}   \textbf{T}ext \textbf{C}ompare \\
%------------------------------------------------------
% Example chapter
%------------------------------------------------------
...
\end{itemize}
Mostly all calculation are performed by roughly, because there are many criteria how to evaluate the logic difference. But from this perspective these rules are enough to examine similarity.
