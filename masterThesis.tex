...
\\
Clone detection process includes several steps:
\begin{enumerate}
  \item Lexical analysis - each line of code is divided into tokens depending on programming language. The tokens are parsed via lexical analyzer which performs formatting of tokens, the rules described above. Thereby the source code is reconstructed.
  \item Transformation - 
