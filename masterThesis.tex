...
The code fragments test1 and test2 have the same business logic but different variables. However in one of them the increment of variable is differently written. From text to text compare the functions are different and it's highlighted as on picture. And this difference is
