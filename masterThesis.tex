...
%HOW TO IMPROVE TEXT TO TEXT COMPARE WITHIN AST TREES
\begin{figure}[h]
  \centering
...
This example \ref{fig:text-to-text-compare-shifted} demonstrates how text compare is not available to notice the string difference in case some operators have been simply replaced. Namely the operators: \texttt{case 0:} and \texttt{case 4:} have been replaced but text compare find this difference using sub-suffix algorithm 
