...
When PDG tree is built, 

Once a set of PDGs are obtained from a subject program, isomorphic sub-graph matching algorithm is
applied for ¯nding similar subgraphs which are returned as clones.
