...
\\
The statistical data can be also provide an information about:
\begin{itemize}
	\item How many \texttt{if}-conditions have been changed of redundant.
	\item How much code redundancy in both code fragments.
\end{itemize}
