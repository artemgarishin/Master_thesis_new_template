...
\end{tabular}
\caption[Experimental results between textual and structural comparison on flowcharts]{The table demonstrates results of java-source code comparison using text-to-text compare method and application of algorithms to their flowchart diagrams.}
